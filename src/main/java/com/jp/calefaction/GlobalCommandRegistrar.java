...
public class GlobalCommandRegistrar implements ApplicationRunner {
    ...
    // This method will run only once on each start up and is automatically called with Spring so
    // blocking is okay.
    @Override
    public void run(ApplicationArguments args) throws IOException {
        ...
        */
        applicationService
                ...
                .doOnNext(ignore -> LOGGER.debug("Successfully registered Global Commands {}", commands))
