...
// import com.jp.calefaction.config.YoutubeConfigProperties;
...
// @Slf4j
// @AllArgsConstructor
// public class YoutubeMessageListener {
...
//     private final YoutubeConfigProperties configProperties;

//     String[] ytMatch = {"www.youtube.com/watch?v", "youtu.be/"};

//     public Mono<Void> checkForURLsAndAct(MessageCreateEvent event, String messageContent) {
//         if (configProperties.isDisabled()) {
//             log.info("This feature is currently disabled. Doing nothing...");
//             return Mono.empty();
//         }
...
//     public boolean containsMatchedString(String input) {
//         List<String> substrings = configProperties.getPatterns();
